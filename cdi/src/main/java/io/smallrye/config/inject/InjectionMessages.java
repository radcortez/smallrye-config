...
public interface InjectionMessages {
    ...
    ConfigException retrieveConfigPropertiesFailure(String prefix, String className, String causeMessage,
            @Cause Exception e);

    @Message(id = 2004, value = "Failed to create @ConfigMapping bean with prefix %s for interface %s. %s")
    ConfigException retrieveConfigMappingsFailure(String prefix, String interfaceName, String causeMessage,
            @Cause Exception e);
    ...
    @Message(id = 2008, value = "Required property %s not found")
